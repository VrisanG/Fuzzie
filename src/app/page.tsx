...
import { HeroParallax } from "@/components/global/HeroParalax";
  ...
  return (
    ...
    <main className="flex flex-col items-center justify-start">
      ...
      <section className="min-h-screen w-full bg-neutral-950 rounded-md relative flex flex-col items-center antialiased overflow-hidden">
        <div className="absolute inset-0 h-full w-full px-5 py-24 [background:radial-gradient(125%_125%_at_50%_10%,#000_35%,#414345_100%)]"></div>
        <div className="flex flex-col mt-[-100px] md:mt-[-50px] items-center">
          <ContainerScroll
            titleComponent={
              <div className="flex flex-col items-center pt-10">
                ...
                <h1 className="text-5xl md:text-8xl bg-clip-text text-transparent bg-gradient-to-b from-white to-black font-sans font-bold pb-10">
        ...
        <InfiniteMovingCards
          className="md:mt-[70px] mt-[-50px] justify-center items-center"
          items={clients}
          direction="right"
          speed="slow"
        />
